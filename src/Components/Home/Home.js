      ...
      <div class="row probootstrap-vh-100 align-items-center text-center">
        <div class="col-sm">
          <div class="probootstrap-text">
            <h1 class="probootstrap-heading text-white mb-4">Viralkan bisnismu!</h1>
            <div class="probootstrap-subheading mb-5">
              <p class="h4 font-weight-normal">Dapatkan bonus dengan men-share bisnismu!</p>
            </div>
            <p><a href="#whatisviralin" class="btn btn-primary mr-2 mb-2">Selengkapnya</a></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md pr-md-5 pr-0 mb-5">
          <h1 class="mb-4 display-5">Solusi untuk Bisnis</h1>
          <div id = "viralin" class="probootstrap-item mb-4">
            <h3>Free Download</h3>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 pl-md-5 pb-5 order-md-2 order-1">
          <h2 class="mb-4 display-5 probootstrap-heading">Visi Kami</h2>
          <div class="probootstrap-item mb-4">
            <h3>Free Download</h3>
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
          </div>
